...
/**
 * The one adapter between this package's own `cf.ts` and `@saptools/core`'s
 * cloud-logging modules.
 *
 ...
 * no cast; none of them mention `CfExecContext`. Mirrors cf-metrics's and
 * cf-otel's identical adapters.
 */
