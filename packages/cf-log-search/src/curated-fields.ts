...
export const CURATED_FIELDS: readonly CuratedField[] = [
  ...
  { field: "vcap_request_id", type: "text (+.keyword)", appliesTo: "all", notes: "the reliable per-hop join key — also present as an OTel span attribute (http@request@header@x-vcap-request-id) on otel-v1-apm-span-*" },
