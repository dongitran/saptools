...
export interface AttachedExplorerSession {
  ...
  readonly roots: (options?: AttachedDiscoveryOptions) => Promise<RootsResult>;
  readonly ls: (options: AttachedLsOptions) => Promise<LsResult>;
  readonly find: (options: AttachedFindOptions) => Promise<FindResult>;
  readonly grep: (options: AttachedGrepOptions) => Promise<GrepResult>;
  readonly view: (options: AttachedViewOptions) => Promise<ViewResult>;
  readonly inspectCandidates: (
...
export interface Explorer {
  readonly roots: (options?: Omit<DiscoveryOptions, "runtime" | "target">) => Promise<RootsResult>;
  readonly instances: (options?: Omit<DiscoveryOptions, "runtime" | "target">) => Promise<InstancesResult>;
  readonly ls: (options: Omit<LsOptions, "runtime" | "target">) => Promise<LsResult>;
  readonly find: (options: Omit<FindOptions, "runtime" | "target">) => Promise<FindResult>;
  readonly grep: (options: Omit<GrepOptions, "runtime" | "target">) => Promise<GrepResult>;
  readonly view: (options: Omit<ViewOptions, "runtime" | "target">) => Promise<ViewResult>;
  readonly inspectCandidates: (
    options: Omit<InspectCandidatesOptions, "runtime" | "target">
  ) => Promise<InspectCandidatesResult>;
  readonly sshStatus: (options?: Omit<LifecycleOptions, "runtime" | "target">) => Promise<LifecycleResult>;
  readonly enableSsh: (options: Omit<LifecycleOptions, "runtime" | "target">) => Promise<LifecycleResult>;
  readonly restartApp: (options: Omit<LifecycleOptions, "runtime" | "target">) => Promise<LifecycleResult>;
  readonly prepareSsh: (options: Omit<LifecycleOptions, "runtime" | "target">) => Promise<LifecycleResult>;
