...
import { cfApi, cfAuth, cfEnv, cfTargetOrg, cfTargetSpace } from "./cf.js";
import { extractHanaBindingsFromCfEnv } from "./db-parser.js";
import {
  appendDbSyncHistory,
...
import { readRuntimeState, readStructure } from "./structure.js";
import type {
  AppDbSnapshot,
  CfStructure,
  CfDbSnapshot,
