...
let counter = 0; function mutateCounter() { counter += 100; return counter; }

function handle(payload) {
  const user = { id: payload.id, name: payload.name, token: payload.token }; const mutationProbe = mutateCounter;
