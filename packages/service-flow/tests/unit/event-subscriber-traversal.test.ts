...
import type { ContextBinding } from '../../src/trace/contextual-runtime-state.js';
import { TraversalScopeScheduler,
  type TraversalScopeIdentity } from '../../src/trace/traversal-scope.js';
import { enqueueCausalScope, type PendingTraceRootScope,
  type TraceQueueScope } from '../../src/trace/trace-root-scopes.js';
...
describe('event subscriber trace traversal', () => {
  ...
  it('locks non-async repo-wide detailed output and ordering', () => {
    ...
    expect({
      ...
      json: 'f025f2a0c73b083a933d32836b296eea1516bdb879b22b2e51aa54f3557e828d',
      mermaid: '10cff08ed95908a87543885fe40bf2aa691b70ce7a429aeadc105848408fb66a',
    });
  });
  ...
  it('locks the accepted Gate-A detailed renderer topology', () => {
    ...
    expect({
      ...
      table: '3f1862dc5b7909e3adb07759ff4ca0155841b4b759016a78109c2ba1704d0d23',
      json: '192209555e334c3ac0a59a7cb13d858de9183b485f2eb224e36f723332861d3e',
      mermaid: '6b0f3014cf17181b2ce41f4789922bd905d56537c63baecc151b3e23884bd789',
    });
  });
});
