...
> [!IMPORTANT]
> Package `0.1.76` uses schema 15 and advances fact compatibility to analyzer `0.1.76-facts.1`. Receiver classification and terminal event-dispatch semantics changed, so every existing workspace requires:
>
> ```bash
